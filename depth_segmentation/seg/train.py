...
if __name__ == '__main__':
    ...
    dataset = SegDataset(opt.dataset_root, '../DenseFusion/datasets/ycb/dataset_config/train_data_list.txt', True, 5000)
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=opt.batch_size, shuffle=True, num_workers=int(opt.workers))
    test_dataset = SegDataset(opt.dataset_root, '../DenseFusion/datasets/ycb/dataset_config/test_data_list.txt', False, 1000)
